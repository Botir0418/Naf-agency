            ...
            <footer className="footer">
                <div className="container">
                    ...
                    <div className="footer__bottom">
                        ...
                        <p className="footer__bottom__address">Toshkent, Chilonzor-11, Maxsud Sheyx-Zoda ko'chasi 33-dom
                            <button className='footer__bottom__address-btn'>
                                <a href="https://goo.gl/maps/Jk6uTECPKJeDaCMGA" className='footer__bottom__address-link'>xaritada</a>
                            </button>
                        </p>
                    </div>
